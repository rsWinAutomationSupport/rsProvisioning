...
Function Create-SshKey {
   ...
   if((Test-Path -Path "C:\Program Files (x86)\Git\.ssh") -eq $false) {
      New-Item -Path "C:\Program Files (x86)\Git\.ssh" -ItemType container 
   }
   Write-Log -value "Creating SSH Key"
   New-Item "C:\Program Files (x86)\Git\.ssh\known_hosts" -ItemType File -Force
   Add-Content "C:\Program Files (x86)\Git\.ssh\known_hosts" -Value "github.com,192.30.252.129 ssh-rsa "
   Add-Content "C:\Program Files (x86)\Git\.ssh\known_hosts" -Value "192.30.252.128 ssh-rsa "
   Add-Content "C:\Program Files (x86)\Git\.ssh\known_hosts" -Value "192.30.252.131 ssh-rsa "
   Add-Content "C:\Program Files (x86)\Git\.ssh\known_hosts" -Value "192.30.252.130 ssh-rsa "
   ...
   if($role -eq "Pull") {
      ...
      chdir (Join-Path $d.wD -ChildPath $d.mR)
